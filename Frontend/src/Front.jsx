...
export function FrontPage() {
  ...
  return (
    <div className="size-full text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex flex-col text-slate-200">
      ...
      <div className="absolute bottom-0 border-t-2 border-slate-800/70 w-full h-[18%] bg-slate-950/30 flex justify-center items-center gap-20 border-slate-400 border-[1px]">
