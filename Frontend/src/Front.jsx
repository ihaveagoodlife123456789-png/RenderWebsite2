...
export function FrontPage() {
  ...
  return (
    <div className="size-full text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex flex-col text-slate-200">
      <div className="absolute top-18 w-[72%] h-[10%] left-[14%] bg-blue-200 rounded-[12px]"></div>
      <div className="absolute right-[10%] w-[6%] h-[8%] bg-blue-500 rounded-[10px]"></div>
      <div className="w-full h-[54%] flex flex-col justify-center items-center gap-8">
        ...
        <h4 className="text-[24px] line-[20px] font-semibold text-slate-950">Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. <br />Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. <br />Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus.</h4>
      </div>
