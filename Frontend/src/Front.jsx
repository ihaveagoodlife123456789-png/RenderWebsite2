...
export function FrontPage() {
  ...
  return (
    <div className="size-full text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex flex-col text-slate-200">
      <div className="absolute top-12 w-[52%] h-[7%] left-[25%] bg-slate-900/70 rounded-[12px]"></div>
      <div className="absolute top-15 right-[10%] w-[5%] h-[5%] bg-blue-700 rounded-[13px] text-center"></div>
      <div className="w-full h-[82%] flex flex-col justify-center items-center gap-14">
      ...
      <div className="absolute bottom-0 w-full h-[18%] bg-slate-950/30 flex justify-center items-center gap-20 border-slate-400 border-[1px]">
      ...
      <img src="/icons8-wreath-64.png" className="absolute top-16 left-16 size-[50px]"/>
    </div>
  )
}