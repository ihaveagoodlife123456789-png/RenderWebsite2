...
export function FrontPage() {
  ...
  return (
    <motion.div className="size-full text-[35px] flex flex-col text-slate-200 snap-end" drag="y" dragConstraints={{ top: 200, bottom: 0 }} dragElastic={0} dragMomentum={true}>
