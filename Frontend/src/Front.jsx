  ...
  return (
    <div className="size-full text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex flex-col text-slate-200">
      ...
      <div className="w-full h-[66%] flex flex-col justify-center items-center gap-14">
        ...
        <Link to='/form'><motion.h2 className="font-bold text-white bg-blue-900/80 border-blue-950/90 border-[3px] rounded-[15px]" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2 }} whileHover={{ scale: 1.08}}>Write a Message</motion.h2></Link>
      </div>
