  ...
  return (
    <div className="size-full text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex justify-center items-center gap-12 font-semibold text-slate-200">
      <div className="size-full flex flex-col justify-center items-center gap-8">
        ...
        <h4 className="font-[24px] font-semibold">Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. <br />Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. <br />Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus.</h4>
      </div>
      <div className="absolute bottom-0 w-full h-[48%] bg-slate-950/30 flex justify-center items-center gap-20 border-slate-400 border-[1px]">
