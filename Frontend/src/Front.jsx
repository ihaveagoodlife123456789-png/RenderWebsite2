...
export function FrontPage() {
  ...
  return (
    <div className="size-full text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex flex-col text-slate-200">
      ...
      <div className="w-full h-[76%] flex flex-col justify-center items-center gap-14">
      ...
      <div className="absolute bottom-0 w-full h-[26%] bg-slate-950/30 flex justify-center items-center gap-20 border-slate-400 border-[1px]">
