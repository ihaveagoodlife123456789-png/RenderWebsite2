...
export function FrontPage() {
  ...
  return (
    <div className="size-full text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex flex-col text-slate-200">
      <div className="absolute top-15 w-[52%] h-[7%] left-[25%] bg-blue-200 rounded-[12px]"></div>
      <div className="absolute top-20 right-[10%] w-[5%] h-[5%] bg-blue-500 rounded-[13px] text-center"></div>
      <div className="w-full h-[66%] flex flex-col justify-center items-center gap-14">
        ...
        <Link to='/form'><motion.h2 className="font-bold text-white bg-blue-600/80 border-blue-800 border-[3px] rounded-[15px]" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2 }} whileHover={{ scale: 1.08}}>Write a Message</motion.h2></Link>
      </div>
      <div className="absolute bottom-0 w-full h-[34%] bg-slate-950/30 flex justify-center items-center gap-20 border-slate-400 border-[1px]">
