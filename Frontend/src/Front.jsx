...
export function FrontPage() {
  ...
  return (
    <div className="size-full overflow-auto text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex flex-col text-slate-200">
