...
export function FrontPage() {
  ...
  return (
    <div className="size-full text-[35px] bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover bg-center flex flex-col text-slate-200">
      ...
      <h2 className="absolute left-5 text-[25px] font-bold text-indigo-800 border-b-0 border-indigo-900/90" initial={{scale: .3, y: -30}} animate={{scale: 1, y: 0}} whileHover={{borderBottomWidth: '225px'}}>Ascended Horizons</h2>
      <motion.h4 initial={{scale: 1, opacity: 0, color: 'white'}} animate={{ opacity: 1}} transition={{duration: .4}} whileHover={{ scale: 1.06, color: 'golden-orange'}}>About</motion.h4>
      <motion.h4 initial={{scale: 1, opacity: 0, color: 'white'}} animate={{ opacity: 1}} transition={{duration: .4}} whileHover={{ scale: 1.06, color: 'golden-orange'}}>Company</motion.h4>
      <motion.h4 initial={{scale: 1, opacity: 0, color: 'white'}} animate={{ opacity: 1}} transition={{duration: .4}} whileHover={{ scale: 1.06, color: 'golden-orange'}}>Explore</motion.h4>
      <motion.h4 initial={{scale: 1, opacity: 0, color: 'white'}} animate={{ opacity: 1}} transition={{duration: .4}} whileHover={{ scale: 1.06, color: 'golden-orange'}}>Services</motion.h4>
      <h2 className="absolute right-5 text-[26px] text-violet-500" initial={{scale: 1}} whileHover={{scale: 1.08, color: 'white'}}>Sign In</h2>
      </div>
      <div className="absolute font-bold text-[26px] top-15 right-[10%] w-[5%] h-[5%] bg-blue-700 rounded-[13px] text-white" initial={{scale: 1}} whileHover={{scale: 1.08, color: '#1d4ed8', backgroundColor: 'white'}}>Login</div>
