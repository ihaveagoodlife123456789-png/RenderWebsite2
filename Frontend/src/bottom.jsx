...
export function BottomPage() {
    return (
        ...
        <motion.h2 className="size-screen flex justify-center items-center bg-[url('/winter-mountain-5120x2880-24311.jpg')] bg-no-repeat bg-cover">
        <h2 className="font-bold text-[42px] text-amber-600">View users</h2>
        </motion.h2>
        <motion.div className="w-full h-[35%] bg-mist-800/30 relative bottom-0">
        </motion.div>
        </Link>
        </motion.div>
    )
