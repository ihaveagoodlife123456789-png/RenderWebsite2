...
export function BottomPage() {
    ...
    return (
        ...
        <Link to='/users' className="overflow-hidden sm:w-[52%] md:w-[44%] lg:w-[36%] xl:w-[28%] 2xl:w-[20%] sm:h-[74%] md:h-[56%] lg:h-[58%] xl:h-[52%] 2xl:h-[44%] bg-mist-800/60 font-semibold text-[24px] text-blue-600/90 flex flex-col"
