    ...
    return (
        <div className="size-full bg-[url('/snowy-village-5120x2880-20406.jpg')] bg-no-repeat bg-cover flex justify-center items-center" initial={{scale: 0, y: -20}} animate={{scale: 1, y: 0}} transition={{duration: .1}}>
            ...
            {isSubmitSuccessful ? <Link to='/' className="absolute bottom-10"><motion.div className="text-white text-[18px] border-[3px] border-blue-800 font-semibold bg-blue-600/30 size-fit py-[6px] px-[4px] rounded-[6px]" initial={{scale: 0, y: -20}} animate={{scale: 1}} transition={{duration: .1}} whileHover={{scale: 1.06}}>Go home</motion.div></Link> : null}
                ...
                <motion.div className="absolute top-[6%] left-[54%] w-[150px] h-[120px] flex flex-col justify-center items-center bg-slate-950/70 border-gray-900" variants={variants} initial={{scale: 0}} animate={emailTemplate ? 'on' : 'off'}><div><h2>Send email?</h2></div><div className="flex justify-center items-center"><motion.h3 variants={variants} initial={{scale: 1}} animate={emailBooleanTemplate ? 'emailBooleanYes' : null} onClick={() => emailBooleanOnClick()}>Yes</motion.h3><motion.h3 variants={variants} initial={{scale: 1}} animate={emailBooleanTemplate ? null : 'emailBooleanNo'} onClick={() => emailBooleanOnClick()}>No thanks</motion.h3></div></motion.div>
