    ...
    return (
        <div className="size-full bg-[url('/snowy-village-5120x2880-20406.jpg')] bg-no-repeat bg-cover flex justify-center items-center" initial={{scale: 0, y: -20}} animate={{scale: 1, y: 0}} transition={{duration: .1}}>
            ...
            {isSubmitSuccessful ? <Link to='/' className="absolute bottom-10"><motion.div className="text-white text-[18px] border-[3px] border-blue-800 font-semibold bg-blue-600/30 size-fit py-[6px] px-[4px] rounded-[6px]" initial={{scale: 0, y: -20}} animate={{scale: 1}} transition={{duration: .1}} whileHover={{scale: 1.06}}>Go home</motion.div></Link> : null}
                ...
                <motion.h3 className="size-fit text-[26px] text-orange/600 text-slate-300 absolute left-[30%] top-[4%] border-bottom-[2px] border-white" initial={{color: 'white'}} whileHover={{color: 'gold', scale: 1.04, cursor: 'pointer'}} onClick={() => colorSchema()}>Possible colors</motion.h3>
                <motion.h3 className="size-fit text-[26px] text-orange/600 text-slate-300 absolute left-[42%] top-[4%] border-bottom-[2px] border-white" initial={{color: 'white'}} whileHover={{color: 'gold', scale: 1.04, cursor: 'pointer'}}>Preview</motion.h3>
                <motion.h3 className="size-fit text-[26px] text-orange/600 text-slate-300 absolute left-[54%] top-[4%] border-bottom-[2px] border-white" initial={{color: 'white'}} whileHover={{color: 'gold', scale: 1.04, cursor: 'pointer'}}>Send email</motion.h3>
