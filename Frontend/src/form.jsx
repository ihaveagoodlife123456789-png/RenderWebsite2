...
export function FormPage() { 
    return (
        <div className="size-full bg-[url('/snowy-village-5120x2880-20406.jpg')] bg-no-repeat bg-cover flex justify-center items-center">
            ...
            <h1 className="text-white font-semibold font-[45px]">Create a Message</h1>
            <motion.form className="flex flex-col align-items justify-content gap-5 font-semibold text-slate-200">
                ...
                <motion.button className="size-fit bg-blue-800 font-[28px] rounded-[15px] py-[6px] px-[10px]">Submit</motion.button>
            </motion.form>
                <Link to='/'><motion.div className="text-white abosolute top-5 left-5 bg-blue-600/90 size-fit py-[4px] px-[2px]" initial={{scale: 0, y: -20}} animate={{scale: 1, y: 0}} transition={{duration: .2}} onHover={{scale: 1.4}}>Go home</motion.div></Link>
            </div>
        </div>
    )
}