...
export function TopPage() {
  ...
  return (
    ...
    initial={{ opacity: 0 }}
        ...
        viewport={{ once: false }}
    >
      <div className="fixed flex items-center justify-center gap-5 text-white font-semibold sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px] 2xl:text-[22px] top-12 w-[52%] h-[7%] left-[25%] bg-slate-600/70 rounded-[12px] md:left-[5%] md:h-[62%] md:w-[7%] md:top-[15%] md:flex-col md:gap-10">
