...
export function TopPage() {
  ...
  return (
    <motion.div className="size-full text-[35px] flex flex-col text-slate-200 snap-start scroll-smooth" id="top">
      ...
      <motion.a className="size-fit" initial={{scale: 1, opacity: 0, color: 'white'}} animate={{ opacity: 1}} whileHover={{ scale: 1.08, color: 'orange', pointer: 'cursor'}} href={`#${services}`}>Services</motion.a>
