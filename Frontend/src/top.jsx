...
export function TopPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div className="size-fit py-2 px-3 fixed font-bold text-[26px] top-15 sm:right-[4%] md:right-[5%] lg:right-[6%] xl:right-[80%] 2xl:right-[10%] bg-blue-700 rounded-[13px] text-white " initial={{scale: 1, color:'white', backgroundColor: '#1d4ed8'}} whileHover={{scale: 1.08, color: '#1d4ed8', backgroundColor: 'white', pointer: 'cursor'}}>Login</motion.div>
