  ...
  return (
    ...
    >
      ...
      <div className="w-full h-[88%] flex flex-col justify-center items-center gap-20">
        ...
        <Link to='/dashboard'><motion.h2 className="text-fuschia-600 font-semibold text-[16px]" initial={{ opacity: 0, y: -20, color: '#C026D3'}} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2 }} whileHover={{ scale: 1.08, color: 'white'}}>Dashboard</motion.h2></Link>
      </div>
